...
#define TIME_SEGURITY_END   20000    // 20 seg
...
void app_main() {
    ...
    timer_seguridad = xTimerCreate("seguridad", pdMS_TO_TICKS(TIME_SEGURITY_END), pdFALSE, NULL, on_timer_seguridad);
    ...
    startOrResetTimer(timer_seguridad,"INTI-TIMER");
}
